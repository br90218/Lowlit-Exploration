...
Shader "Horizon[ON]/Horizon[ON] Tree Cutout" {
    Properties {
        ...
        _LightWrapping ("Light Wrapping", Range(0, 1)) = 0.5
        _FrontLightDamping ("FrontLightDamping", Range(0, 1)) = 0.2
    ...
    SubShader {
        ...
        Pass {
            ...
            half3 Output = (TransCol*(LightAtten*0.85+0.15)*A*B);
            return Output;
            }
            ...
            uniform float _FrontLightDamping;
...
/////// Diffuse:
                ...
                float4 node_3420 = Snow( normalDirection , i.posWorld.g , _SnowColor.rgb , _SnowAmount , _SnowSlopeDamp , _SnowOutputColorBrightness2Coverage , _SnowHeight , _SnowHeightTransition , (Dif( _Tint1.rgb , _Tint2.rgb , i.posWorld.rgb , _VariationMapScale , _LeavesMask_var.a , _VariationMapA )*_MainTex_var.rgb) );
                ...
                float3 diffuseColor = lerp((_DiffuseMulti*(saturate((node_8784 + ( (dot(i.normalDir,lightDirection) - node_8164) * ((1.0 - _FrontLightDamping) - node_8784) ) / (node_8784 - node_8164)))*(node_3420.rgb+Backlighting( _BacklightMapA_var.a , _BacklightTint.rgb , i.normalDir , lightDirection , attenuation , node_5619 , _BacklightStrength )))),float3(node_4447,node_4447,node_4447),MyFog);
