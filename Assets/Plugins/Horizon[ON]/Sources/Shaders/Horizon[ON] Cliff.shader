Shader "Horizon[ON]/Horizon[ON] Cliffs" {
    Properties {
[BlockInfo(1.0,1.0,1.0,1.0)] dummy_begin ("Features", Float) = 1
	    [KeywordEnum(One, Two, Three, Four)] _LayerCount ("   Layer count", Float) = 3
	    [HideInInspector][KeywordEnum(Ambient, Cubemap, SkyshopSH, UnitySH)] _IBLDiff ("   Diffuse Ambient Lighting Mode", Float) = 3
...
[BlockInfo(1.0,0.5,0.5,0.8, 1, indent)] dummy_main ("Main settings", Float) = 1    
        ...
        [HideByProp(_IBLDiff.1.2.3, dummy_main)] _AmbientIBL ("         Ambient > diff IBL", Range(0, 1)) = 1
...
[BlockInfo(0.5,1.0,0.5,1.0, 1, indent)] dummy_layer1 ("Layer 1 properties", Float) = 0
        ...
        [PropBlock(dummy_layer1)] _BaseGloss ("       A = Gloss", Float) = 0
        ...
        [HideByProp(dummy_layer1)] _SpecGloss ("   Spec / Gloss", Color) = (0.1, 0.1, 0.1, 0.2)
...
[BlockInfo(0.5,1.0,0.5,1.0, 1, _LayerCount.1.2.3)] dummy_layer2 ("Layer 2 properties", Float) = 0
        ...
        [PropBlock(dummy_layer2, _LayerCount.1.2.3)] _BlendGloss1 ("       A = Gloss", Float) = 0
        ...
        [HideByProp(dummy_layer2, _LayerCount.1.2.3)] _SpecGlossBlend1 ("   Spec / Gloss", Color) = (0.1, 0.1, 0.1, 0.2)
...
[BlockInfo(0.5,1.0,0.5,1.0, 1, _LayerCount.2.3)] dummy_layer3 ("Layer 3 properties", Float) = 0
        ...
        [PropBlock(dummy_layer3, _LayerCount.2.3)] _BlendGloss2 ("       A = Gloss", Float) = 0
        ...
        [HideByProp(dummy_layer3, _LayerCount.2.3)] _SpecGlossBlend2 ("   Spec / Gloss", Color) = (0.1, 0.1, 0.1, 0.2)
...
[BlockInfo(0.5,1.0,0.5,1.0, 1, _LayerCount.3)] dummy_layer4 ("Layer 4 properties", Float) = 0
        ...
        [PropBlock(dummy_layer4, _LayerCount.3)] _BlendGloss3 ("       A = Gloss", Float) = 0
        ...
        [HideByProp(dummy_layer4, _LayerCount.3)] _SpecGlossBlend3 ("   Spec / Gloss", Color) = (0.1, 0.1, 0.1, 0.2)
...
[BlockInfo(0.9,0.9,1.0,1.0, 1, _IBLDiff.1.2.3)] dummy_ambient ("Diffuse Ambient Lighting", Float) = 1
        //[PropBlock(_IBLSpec, LOGICOR_IBLDiff.1)]  _IBL_HDR("   IBL cubemap is HDR/RGBM", Float) = 1
        //[HideByProp(dummy_ambient, _IBLDiff.1, 0)] _DiffuseIBLCubemap ("   Diffuse Cubemap", Cube) = "_Skybox" {}
        [HideByProp(dummy_ambient, _IBLDiff.1.2.3)] _DiffIBLMulti ("   Exposure", Float ) = 1

[BlockInfo(0.9,0.9,1.0,1.0, 1, _IBLSpec)] dummy_specular ("Specular Ambient Lighting", Float) = 1
        //[PropBlock(_IBLSpec, LOGICOR_IBLDiff.1)]  _IBL_HDR("IBL cubemap is HDR/RGBM", Float) = 1
        //[HideByProp(dummy_specular, _IBLSpec, 0)] unity_SpecCube0 ("   Reflection Cubemap", Cube) = "_Skybox" {}
        //[Foldout(dummy_specular, _IBLSpec)] _AdvIBLProps ("   Spec IBL sampling props", Float) = 0
        [HideByProp(dummy_specular, _IBLSpec)] _IBLSpecRoughMIP ("     Rough MIP Level", Float) = 5
        [HideByProp(dummy_specular, _IBLSpec)] _IBLMIPDim_Rough ("     Rough Multi", Float) = 1
        [HideByProp(dummy_specular, _IBLSpec)] _IBLSpecGlossMIP ("     Glossy MIP Level", Float) = 0
        [HideByProp(dummy_specular, _IBLSpec)] _IBLMIPDim_Gloss ("     Glossy Multi", Float) = 1    
    
[BlockInfo(0.5,1.0,0.5,1.0, 1, indent)] dummy_cliff ("Cliff (2planar mapped)", Float) = 1
        [HideByProp(dummy_cliff)] _CliffColormap ("   Colormap (RGB) + A", 2D) = "white" {}
        [PropBlock(dummy_cliff)] _CliffGloss ("      A = Gloss", Float) = 0
        [PropBlock(dummy_cliff)] _CliffEmission ("      A = Emission", Float) = 0
        [HideByProp(dummy_cliff)] _SpecGlossCliff ("   Spec / Gloss", Color) = (0.1, 0.1, 0.1, 0.2)
        [HideByProp(dummy_cliff, 0)] _CliffNormalmap ("   Normalmap", 2D) = "bump" {}
        
[BlockInfo(0.5,1.0,0.5,1.0, 1, indent)] dummy_cliffdetail ("Cliff Detail", Float) = 1
        [KeywordEnum(None, Color, Normals)] _CliffDetail ("   Cliff Detail Type", Float) = 0
        [HideByProp(dummy_cliffdetail, _CliffDetail.1.2)] _CliffDetailmap ("   Detail Colormap", 2D) = "gray" {}
        [HideByProp(dummy_cliffdetail, _CliffDetail.1.2)] _CliffDetailColorIntensity ("      Detail Colormap Intensity", Range(0,1)) = 1
        //[WarningInfo(dummy_cliffdetail, _CliffDetail.2)] dummy_cliff_normal_info ("Cliff Detail Normalmap below is NOT AVAILABLE with Diffuse Ambient Lighting of type Cubemap", Float) = 0
        [HideByProp(dummy_cliffdetail, _CliffDetail.2, 0)] _CliffDetailNormalmap ("   Cliff Detail Normalmap", 2D) = "bump" {}
        [HideByProp(dummy_cliffdetail, _CliffDetail.2)] _CliffDetailNormalIntensity ("   Detail Normalmap Intensity", Range(0, 1)) = 1   
    }
...
//            #define SHADOWS_OFF
            ...
            //#pragma multi_compile _WATER_OFF _WATER_ON
            #define _MESHNORMALS
            #define _CLIFFS
            //#define _HORIZONDISK
            
			#define _IBLDIFF_UNITYSH
            ...
            #pragma shader_feature _CLIFFDETAIL_NONE _CLIFFDETAIL_COLOR _CLIFFDETAIL_NORMALS
            // ===========================================================================================
