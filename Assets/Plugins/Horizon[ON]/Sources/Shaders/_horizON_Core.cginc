            ...
            float4 frag(VertexOutput i) : SV_Target {
            	...
            	float emissiveness=_BaseEmission*colorTex.a;
           		fixed4 emissiveLayerMask=fixed4(_BaseEmission, _BlendEmission1, _BlendEmission2, _BlendEmission3);
            		...
            		specColor = lerp(specColor, _SpecGlossBlend2.rgb, blendVal.g);
            		...
            		specColor = lerp(specColor, _SpecGlossBlend3.rgb, blendVal.b);
				...
				float3 specular=0;
               		...
               		specular += _LightColor0.xyz * atten * NdotL * pow(HdotN, specPow)*fresnelTerm*visTerm*normTerm;
				#endif
