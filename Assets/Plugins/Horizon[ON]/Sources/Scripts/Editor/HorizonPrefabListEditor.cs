...
namespace Horizon
{
    ...
    public class HorizonPrefabListEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Rect rect = EditorGUILayout.GetControlRect( GUILayout.Width(Screen.width - scrollBarWidth), GUILayout.Height(52) );
            ...
            int lineHeight = 0;
            int inline = 0;
            int netScreenWidth = Screen.width - scrollBarWidth;
            int elementWidth = (netScreenWidth) / 4;
